...
| Prosody | F0 and intensity samples inside aligned intervals; pause lengths between aligned words | Raw intensity is sensitive to microphone, gain, and speaker distance |
